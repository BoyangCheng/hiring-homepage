...
<table id="__01" width="1025" height="813" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="2" rowspan="2" width="405" height="20"><table width="100%"  border="0"  background="images/17.gif" height="20">
          ...
          <td width="96%" class="zczi"><a href='#' onclick=window.open('houtai/newsview.jsp?id=<%=news.getId()%>+','newwindow','width=600,height=240,top=300,left=300') class='zczi'><%=news.getTitle() %></a></td>
		  </tr>
		  <%}%>
        </table>
	  </td>
	...
	<tr>
		<td colspan="2">
			<img src="images/10.gif" alt="" width="405" height="22" border="0" usemap="#Map2"  onclick=window.open('houtai/moreNewsBrowse.jsp') class='zczi'></td>
		<td>
