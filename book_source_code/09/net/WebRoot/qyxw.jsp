<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <jsp:useBean id="newsl" class="com.wsy.news" scope="page"/>
...
<TABLE WIDTH=1024 BORDER=0 CELLPADDING=0 CELLSPACING=0>
		...
		<TD WIDTH=402 height="20">
		  ...
		  Iterator it2=temp2.iterator();
		 	while(it2.hasNext()){
              ...
              <td width="95%" valign="middle" class="zczi"><a href='#' onclick=window.open('houtai/newsview.jsp?id=<%=news.getId()%>+','newwindow','width=600,height=240,top=300,left=300') class='zczi'><%=news.getTitle() %></a></td>
			  </tr>
              <%} }
              else{
              for(int i=0;i<15;i++){
	...
	<TR>
		<TD>
			<IMG SRC="images/qyxw/9.gif" ALT="" WIDTH=402 HEIGHT=53 border="0" usemap="#Map3" onclick=window.open('houtai/moreNewsBrowse.jsp') class='zczi'></TD>
	</TR>
	<TR>
		<TD COLSPAN=3>
